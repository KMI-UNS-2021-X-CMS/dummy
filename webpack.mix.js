...
/*  pages resources */
//project
mix.js('resources/js/project.js', 'public/assets/js/custom/');
mix.js('resources/js/kendaraan.js', 'public/assets/js/custom/');
mix.js('resources/js/estimasi.js', 'public/assets/js/custom/');
mix.js('resources/js/jenisakta.js', 'public/assets/js/custom/');
/*  end pages resources */
